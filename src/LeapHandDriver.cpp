            ...
            auto calculateOffsetDistanceX = [&](LEAP_HAND& hand)
                    {
                        ...
                        VrVec3 leapVelocity = hmd_pose.Orientation() * VrVec3(hand.accelerometer.x * dTime, hand.accelerometer.z * dTime, hand.accelerometer.y * dTime);
                        VrVec3 hmdVelocity = VrVec3(pose.vVelocity.v[0], pose.vVelocity.v[1], pose.vVelocity.v[2]);
            ...
            auto calculateOffsetDistanceY = [&](LEAP_HAND& hand)
                    {
                        ...
                        VrVec3 leapVelocity = hmd_pose.Orientation() * glm::vec3(hand.accelerometer.x * dTime, hand.accelerometer.z * dTime, hand.accelerometer.y * dTime);
                        VrVec3 hmdVelocity = VrVec3(pose.vVelocity.v[0], pose.vVelocity.v[1], pose.vVelocity.v[2]);
